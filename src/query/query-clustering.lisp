...
(defmethod and-query-available-p ((a simple-conjunctive-description-query) (b simple-conjunctive-description-query))
  t)

(defmethod or-query-available-p ((a simple-disjunctive-description-query) (b simple-disjunctive-description-query))
  t)
